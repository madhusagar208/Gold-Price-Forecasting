...
st.sidebar.header("P-171   Group 2:")
st.sidebar.write("***Priyanka***",",","***Madhusagar manchodi***")
st.sidebar.write("***Anke Ashoke omkar***",",","***shreya verma***")
st.sidebar.write("***Mohammad sujayath ali***",",","***Pranav Rajendra bhosale***")
st.sidebar.write("***Kaustubh dhananjay gambare***",",","******")